...
if not database:get(bot_id..'ANTIQUES:Reply:Mute'..msg.chat_id_) then
if text == 'هلو' then
TextReply = 'ههلو ، 🥳😹💞'
...
if text == 'علالي' then
TextReply = 'الاب الروحي'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'ليث علاء' then
TextReply = 'مطور سورسات'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == '😐' then
...
database:del(bot_id..'ANTIQUES:Reply:Mute'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'⌔︙تم تفعيل ردود البوت')
return false
end

if text == 'تعطيل ردود البوت' and Owner(msg) then
database:set(bot_id..'ANTIQUES:Reply:Mute'..msg.chat_id_,true)
