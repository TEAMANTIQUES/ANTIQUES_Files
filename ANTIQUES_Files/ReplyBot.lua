...
Dev_Abs(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') 
return false
end
...
DevAbs2 = math.random(#ANTIQUESTEAM) 
Dev_Abs(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM[DevAbs2] , 1, 'md') 
return false
end
...
if text == 'سورس علالي' or text == 'سورس انتيكا' or text == 'سورس ديف انتيكا' or text == 'سورس زربه' or text == 'السورس زربه' or text == 'سورس عاوي' or text == 'السورس عاوي' then 
