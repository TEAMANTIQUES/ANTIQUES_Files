...
if DevAbs:get(ANTIQUES.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(ANTIQUES.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(ANTIQUES.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(ANTIQUES.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(ANTIQUES.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(ANTIQUES.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
ANTIQUESName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if ANTIQUESName then 
ANTIQUESNames = DevAbs:smembers(ANTIQUES.."Abs:Mute:Names"..msg.chat_id_) or ""
...
DevAbs:set(ANTIQUES.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(ANTIQUES.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
