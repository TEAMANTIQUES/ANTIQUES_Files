...
if DevLeo:get(ANTIQUES.."Leo:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevLeo:sadd(ANTIQUES.."Leo:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and DevLeo:get(ANTIQUES.."Leo:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
ANTIQUESName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if ANTIQUESName then 
ANTIQUESNames = DevLeo:smembers(ANTIQUES.."Leo:Mute:Names"..msg.chat_id_) or ""
if ANTIQUESNames and ANTIQUESNames[1] then 
for i=1,#ANTIQUESNames do 
if ANTIQUESName:match("(.*)("..ANTIQUESNames[i]..")(.*)") then 
...
DevLeo:set(ANTIQUES.."Leo:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevLeo:del(ANTIQUES.."Leo:Lock:MuteNames"..msg.chat_id_)
end
end
end
